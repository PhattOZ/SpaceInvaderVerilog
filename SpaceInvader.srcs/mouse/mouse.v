...
module mouse(
    ...
    localparam [2:0]
     ...
     // instantiation
     ps2_rxtx ps2_unit (.clk(clk), .reset(reset), .wr_ps2(wr_ps2),
    ...
    begin
        ...
        case (state_reg)
            ...
            begin
                ...
                begin
                    state_next = pack2;
                    y_next[8] = rx_data[5];     // Y-axis direction
                    x_next[8] = rx_data[4];     // X-axis direction
                    btn_next = rx_data[2:0];    // 0: left button, 1: right button, 2: middle button
                end
            end
            ...
            begin
                ...
                begin
                    state_next = pack3;
                    x_next[7:0] = rx_data;      // X-axis movement 
                end
            end
            ...
            begin
                ...
                begin
                    state_next = done;
                    y_next[7:0] = rx_data;      // Y-axis movement
                end
            end
            done:       // board successfully receives all packet
            begin
                m_done_tick = 1'b1;
                state_next = pack1;             // ready to receive packet again
            end
         endcase
    end
